...
class GowinGW1NPlatform(TemplatedPlatform):
    ...
    The toolchain version "V1.9.7Beta" has been tested and confirmed working. Other versions
    may also work, however they seem to change significantly between each release.
    ...
    **TODO**
    ...
    _apicula_command_templates = [
        ...
        {{invoke_tool("nextpnr-gowin")}}
            ...
            --log {{name}}.tim
            --device {{platform.family}}-{{platform.voltage}}{{platform._device_suffix}}{{platform.package}}{{platform.speed}}
            --json {{name}}.json
            --cst {{name}}.cst
        ...
        {{invoke_tool("gowin_pack")}}
            ...
            --device {{platform.family}}-{{platform._device_suffix}}
            --output {{name}}.fs
            {{name}}_pnr.json
        """,
